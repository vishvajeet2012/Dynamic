                        ...
                        <div className="pb-2 px-3">
                          {cat.subcategories?.length > 0 ? (
                            <ul className="space-y-2">
                              {cat.subcategories.map(sub => (
                                <li key={sub._id} className={`rounded border ${selectedSubcategory?._id === sub._id ? 'bg-blue-50 border-blue-300' : 'bg-gray-50 border-gray-200'}`}>
                                      ...
                                      {sub.childCategories?.length > 0 ? (
                                        <ul className="space-y-1">
                                          {sub.childCategories.map(child => (
                                            <li key={child._id} className={`flex items-center justify-between p-1 text-xs rounded ${selectedChildCategory?._id === child._id ? 'bg-blue-100' : 'bg-gray-100'}`}>
                                              <div className="flex items-center space-x-2">
